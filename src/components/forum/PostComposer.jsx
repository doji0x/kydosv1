  ...
  return (
    <div className="flex gap-3 p-4 border-b border-border">
      ...
      <div className="flex-1 min-w-0">
        ...
        {(showImage || image) && (
          <MediaUploadField value={image} onChange={setImage} allowVideo className="mt-2" />
        )}
        <div className="flex items-center justify-between mt-2">
          <div className="flex items-center gap-1">
            ...
            <button type="button" onClick={() => setShowImage((s) => !s)} className="h-8 w-8 rounded-full flex items-center justify-center text-primary hover:bg-primary/10" aria-label="Add image or video"><ImagePlus className="h-4 w-4" /></button>
          </div>
