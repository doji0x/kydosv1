...
export async function runSpecialist({apiKey,toolsModel,githubToken,base44,role,job,context,log,beforeWrite,recordAuditIssue,repoState,previousCheckpoint,startedAt=Date.now(),softBudgetMs=DEFAULT_SOFT_BUDGET_MS}){
