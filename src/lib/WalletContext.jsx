...
export function WalletProvider({children}){
  ...
  useEffect(()=>{ refresh(); if(!ethereum)return; ethereum.on("accountsChanged",refresh); ethereum.on("chainChanged",refresh); return()=>{ethereum.removeListener("accountsChanged",refresh);ethereum.removeListener("chainChanged",refresh);};},[]);
